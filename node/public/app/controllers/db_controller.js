...
DBController = (function(_super) {
  ...
  DBController.prototype.tutorServerUrl = "http://" + window.location.hostname + ":8080/api/v1/cards/";
  ...
  function DBController() {
    this.buildDeckInfo = __bind(this.buildDeckInfo, this);
    DBController.__super__.constructor.apply(this, arguments);
  }
